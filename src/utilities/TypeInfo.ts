...
import type { ASTNode, FieldNode, FragmentDefinitionNode, FragmentSpreadNode } from '../language/ast.js';
    ...
    switch (node.kind) {
      ...
      case Kind.ARGUMENT: {
        ...
        if (directive) {
          ...
          const fragmentDef =
            this._fragmentDefinitions.get(fragmentSpread.name.value);
          ...
          if (fragVarDef) {
            ...
            if (isInputType(fragVarType)) {
              ...
              // TODO: follow up on https://github.com/graphql/graphql-js/pull/3835/files#r1101831098
